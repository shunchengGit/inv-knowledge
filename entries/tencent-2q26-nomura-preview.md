...
- **细分业务动能**：
  ...
  - **网络广告**：营收预计+18% YoY，视频号广告加载率与变现效率提升是核心驱动。
  - **金融科技与企业服务 (FBS)**：营收预计+9% YoY，其中企业服务（腾讯云）营收增速由1Q26的20%进一步加速至22%。
- **AI 战略成效**：
  - **混元 3.0**：7月初发布的正式版能力显著超越4月预览版，开发者认可度高，快速缩小与全球领先模型的差距。
  - **WorkBuddy 桌面 Agent**：据Analysys数据，截至2026年3月月访问量达885万，为国内最受欢迎的桌面AI Agent；但阿里与字节竞品相继推出，竞争加剧。
- **盈利与估值预测**：微调FY26F与FY27F Non-IFRS净利润预测-2%/-1%，维持买入评级与SOTP目标价727.00港元（对应FY27F PE 20x，目前当前股价仅12.7x，安全边际极高）。

## 关联
- [腾讯2Q26业绩前瞻与微信AI Agent里程碑](entries/tencent-2q26-preview-and-weixin-ai-agent-milestones.md) —— 对比汇丰HSBC关于微信AI Agent变现与2Q26前瞻的分析。
- [腾讯控股JPM 1Q26：转向更积极，双P&L披露化解AI稀释担忧](entries/腾讯控股JPM-1Q26-转向更积极-双P-L披露化解AI稀释担忧.md) —— 结合摩根大通关于AI资本开支与双P&L拆解的逻辑比较。

## 引用
- [Nomura - Tencent Holdings 2Q26F: margin likely under pressure on AI investment](res/腾讯控股/2026-07-13-0700.HK-Nomura-Tencent Holdings (700 HK) (Buy) - 2Q26F margin likely under...-123124523.pdf)
